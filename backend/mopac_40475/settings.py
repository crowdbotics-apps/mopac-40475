"""
Django settings for mopac_40475 project.
...
WSGI_APPLICATION = 'mopac_40475.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mopac_40475 API",
    "DESCRIPTION": "API documentation for mopac_40475 App",
    "VERSION": "v1",
}
